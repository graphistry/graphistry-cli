...
| **~~1.0 API Key~~** | ~~`./graphistry exec streamgl-vgraph-etl curl "..."`~~ | **REMOVED**: API v1 VGraph has been permanently removed. Use JWT tokens via the [v2 REST API](https://hub.graphistry.com/docs/api/2/rest/auth/). |
